  ...
  <div class="min-h-screen bg-white">
    <div class="max-w-2xl mx-auto px-4 py-12">
      <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">{{ $t('starter.title') }}</h1>
        <p class="text-gray-600 mb-4">
          {{ $t('starter.subtitle') }}
        </p>
        <div class="inline-flex items-center bg-blue-50 px-4 py-2 rounded-lg">
          <span class="text-gray-600">$7{{ $t('common.pricing.perUser') }}</span>
        </div>
      </div>
      ...
      <div class="mt-12 space-y-8">
        <div class="bg-white border border-gray-200 p-6">
          <h2 class="text-xl font-semibold text-gray-900 mb-6">{{ $t('starter.features.title') }}</h2>
          <div class="space-y-4">
            <div v-for="(feature, key) in features" :key="key" class="flex items-start">
              ...
              <div>
                <h3 class="text-sm font-medium text-gray-900">{{ $t(`starter.features.${key}.title`) }}</h3>
                <p class="text-sm text-gray-600">{{ $t(`starter.features.${key}.description`) }}</p>
              </div>
            </div>
          </div>
        </div>
