...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Get exclusive 10% discount on Google Workspace Business plans with GWsave promo codes."}],"link":[{"rel":"icon","type":"image/svg+xml","href":"https://assets.gwsave.com/icon.svg"}],"style":[],"script":[],"noscript":[],"title":"GWsave - Google Workspace Promo Codes"};
...
const _lazy_jf94p5 = () => Promise.resolve().then(function () { return feed$1; });
const _lazy_DwoFbK = () => Promise.resolve().then(function () { return robots$1; });
const _lazy_JiENEr = () => Promise.resolve().then(function () { return userIp$1; });
...
const feed$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: feed
});
...
const robots = defineEventHandler(async (event) => {
  ...
  try {
    ...
    await writeFile(join$1(process.cwd(), "public", "robots.txt"), content);
    return { success: true };
  } catch (error) {
...
const robots$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: robots
});
...
const userIp$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: userIp
});
