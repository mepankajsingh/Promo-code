import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, unref, version, ref, watchEffect, watch, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, computed, defineComponent, h, Fragment, createVNode, Text, resolveComponent, mergeProps, withCtx, toDisplayString as toDisplayString$1, useSSRContext, provide, Suspense, createBlock, createTextVNode, openBlock, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "ofetch";
import { baseURL as baseURL$1 } from "#internal/nuxt/paths";
import { createHooks } from "hookable";
import { getContext } from "unctx";
import { sanitizeStatusCode, createError as createError$1, setCookie, getHeader, getRequestHeaders, getRequestHeader, getCookie, deleteCookie } from "h3";
...
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    name: "about___en",
    path: "/about",
    component: () => import("./_nuxt/about-1OCbWMFY.js")
  },
  {
    name: "about___fr",
    path: "/fr/about",
  ...
  },
  {
    name: "admin___en",
    path: "/admin",
    component: () => import("./_nuxt/index-BXQsteWO.js")
  },
  {
    name: "admin___fr",
    path: "/fr/admin",
  ...
  },
  {
    name: "contact___en",
    path: "/contact",
    component: () => import("./_nuxt/contact-DWmq2dCW.js")
  },
  {
    name: "contact___fr",
    path: "/fr/contact",
  ...
  },
  {
    name: "index___en",
    path: "/",
    component: () => import("./_nuxt/index-DjX5YgLJ.js")
  },
  {
    name: "index___fr",
    path: "/fr",
  ...
  },
  {
    name: "login___en",
    path: "/login",
    component: () => import("./_nuxt/login-CSL70jSZ.js")
  },
  {
    name: "login___fr",
    path: "/fr/login",
  ...
  },
  {
    name: "standard___en",
    path: "/standard",
    component: () => import("./_nuxt/standard-Fs1zCjIE.js")
  },
  {
    name: "standard___fr",
    path: "/fr/standard",
  ...
  },
  {
    name: "starter___en",
    path: "/starter",
    component: () => import("./_nuxt/starter-CAjzOPEY.js")
  },
  {
    name: "starter___fr",
    path: "/fr/starter",
  ...
  },
  {
    name: "updates___en",
    path: "/updates",
    component: () => import("./_nuxt/updates-Ca2d2VpR.js")
  },
  {
    name: "updates___fr",
    path: "/fr/updates",
...
const namedMiddleware = {
  admin: () => import("./_nuxt/admin-CAP6StVI.js")
};
