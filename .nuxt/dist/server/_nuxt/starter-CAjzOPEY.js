...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    useHead({
      title: "Google Workspace Business Starter Promo Code - 10% Discount",
      meta: [
        {
          name: "description",
          content: "Get your exclusive 10% discount promo code for Google Workspace Business Starter plan."
        }
      ]
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-white" }, _attrs))}><div class="max-w-2xl mx-auto px-4 py-12"><div class="text-center mb-8"><h1 class="text-3xl font-bold text-gray-900 mb-2">${ssrInterpolate(_ctx.$t("starter.title"))}</h1><p class="text-gray-600 mb-4">${ssrInterpolate(_ctx.$t("starter.subtitle"))}</p><div class="inline-flex items-center bg-blue-50 px-4 py-2 rounded-lg"><span class="text-gray-600">$7${ssrInterpolate(_ctx.$t("common.pricing.perUser"))}</span></div></div><div class="bg-gray-50 p-6 mb-6"><form class="space-y-6">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/starter.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=starter-CAjzOPEY.js.map
