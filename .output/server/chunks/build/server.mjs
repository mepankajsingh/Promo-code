import { defineComponent, ref, h, resolveComponent, toRef, isRef, getCurrentInstance, computed, inject, watchEffect, watch, hasInjectionContext, shallowRef, unref, version, provide, shallowReactive, Suspense, Fragment, createApp, createVNode, Text, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, mergeProps, withCtx, createBlock, createTextVNode, openBlock, toDisplayString as toDisplayString$1, getCurrentScope, useSSRContext } from 'vue';
import { c as createError$1, k as sanitizeStatusCode, l as getContext, $ as $fetch, m as createHooks, s as setCookie, g as getHeader, t as toRouteMatcher, n as createRouter$1, o as defu, p as getRequestHeaders, q as destr, v as klona, w as parse$1, x as getRequestHeader, y as isEqual$1, z as getCookie, A as deleteCookie } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "about___en",
    path: "/about",
    component: () => import('./about-1OCbWMFY.mjs')
  },
  {
    name: "about___fr",
    path: "/fr/about",
  ...
  },
  {
    name: "admin___en",
    path: "/admin",
    component: () => import('./index-BXQsteWO.mjs')
  },
  {
    name: "admin___fr",
    path: "/fr/admin",
  ...
  },
  {
    name: "contact___en",
    path: "/contact",
    component: () => import('./contact-DWmq2dCW.mjs')
  },
  {
    name: "contact___fr",
    path: "/fr/contact",
  ...
  },
  {
    name: "index___en",
    path: "/",
    component: () => import('./index-DjX5YgLJ.mjs')
  },
  {
    name: "index___fr",
    path: "/fr",
  ...
  },
  {
    name: "login___en",
    path: "/login",
    component: () => import('./login-CSL70jSZ.mjs')
  },
  {
    name: "login___fr",
    path: "/fr/login",
  ...
  },
  {
    name: "standard___en",
    path: "/standard",
    component: () => import('./standard-Fs1zCjIE.mjs')
  },
  {
    name: "standard___fr",
    path: "/fr/standard",
  ...
  },
  {
    name: "starter___en",
    path: "/starter",
    component: () => import('./starter-CAjzOPEY.mjs')
  },
  {
    name: "starter___fr",
    path: "/fr/starter",
  ...
  },
  {
    name: "updates___en",
    path: "/updates",
    component: () => import('./updates-Ca2d2VpR.mjs')
  },
  {
    name: "updates___fr",
    path: "/fr/updates",
...
const namedMiddleware = {
  admin: () => import('./admin-CAP6StVI.mjs')
};
...
const localeLoaders = {
  "en": [{ key: "../locales/en.json", load: () => import(
    './en-JQgmW72T.mjs'
    /* webpackChunkName: "locale__home_project_locales_en_json" */
  ), cache: true }],
  "fr": [{ key: "../locales/fr.json", load: () => import(
    './fr-b0Yi-0up.mjs'
    /* webpackChunkName: "locale__home_project_locales_fr_json" */
  ), cache: true }],
  "es": [{ key: "../locales/es.json", load: () => import(
    './es-DZcU3KMn.mjs'
    /* webpackChunkName: "locale__home_project_locales_es_json" */
  ), cache: true }],
  "pt": [{ key: "../locales/pt.json", load: () => import(
    './pt-B5uGNLON.mjs'
    /* webpackChunkName: "locale__home_project_locales_pt_json" */
  ), cache: true }],
  "de": [{ key: "../locales/de.json", load: () => import(
    './de-C89oXp-E.mjs'
    /* webpackChunkName: "locale__home_project_locales_de_json" */
  ), cache: true }],
  "ja": [{ key: "../locales/ja.json", load: () => import(
    './ja-CKgArws9.mjs'
    /* webpackChunkName: "locale__home_project_locales_ja_json" */
  ), cache: true }],
  "hi": [{ key: "../locales/hi.json", load: () => import(
    './hi-0ogZwkzW.mjs'
    /* webpackChunkName: "locale__home_project_locales_hi_json" */
  ), cache: true }],
  "ru": [{ key: "../locales/ru.json", load: () => import(
    './ru-Bjy-WanV.mjs'
    /* webpackChunkName: "locale__home_project_locales_ru_json" */
  ), cache: true }]
};
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    function getFlagUrl(code2) {
      const countryCode = code2 === "en" ? "us" : code2 === "ja" ? "jp" : code2 === "hi" ? "in" : code2;
      return `https://flagcdn.com/w40/${countryCode}.png`;
    }
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative flex items-center h-full" }, _attrs))}><button class="inline-flex items-center px-2 py-1 text-sm text-gray-700 hover:text-blue-600 focus:outline-none" aria-label="Select language"><div class="flex items-center"><img${ssrRenderAttr("src", getFlagUrl(unref(currentLocale).code))}${ssrRenderAttr("alt", unref(currentLocale).name)} class="w-4 h-3 object-cover" loading="lazy"><span class="ml-1 mr-1">${ssrInterpolate(unref(currentLocale).name)}</span><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></div></button>`);
      if (unref(isOpen)) {
        _push(`<div class="absolute right-0 top-full mt-1 py-1 w-48 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 z-50"><!--[-->`);
        ssrRenderList(unref(availableLocales), (locale2) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            key: locale2.code,
            to: unref(switchLocalePath2)(locale2.code),
            class: ["flex items-center px-3 py-1.5 text-sm text-gray-700 hover:bg-gray-50", { "bg-gray-50": locale2.code === unref(currentLocale).code }]
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<img${ssrRenderAttr("src", getFlagUrl(locale2.code))}${ssrRenderAttr("alt", locale2.name)} class="w-4 h-3 object-cover" loading="lazy"${_scopeId}><span class="ml-2"${_scopeId}>${ssrInterpolate(locale2.name)}</span>`);
              } else {
                return [
                  createVNode("img", {
                    src: getFlagUrl(locale2.code),
                    alt: locale2.name,
                    class: "w-4 h-3 object-cover",
                    loading: "lazy"
                  }, null, 8, ["src", "alt"]),
                  createVNode("span", { class: "ml-2" }, toDisplayString$1(locale2.name), 1)
                ];
              }
            }),
            _: 2
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    const getLocalizedTitle = () => {
      switch (locale.value) {
        case "fr":
          return "Codes promo Google Workspace";
        case "es":
          return "Códigos promocionales de Google Workspace";
        case "pt":
          return "Códigos promocionais do Google Workspace";
        case "de":
          return "Google Workspace Gutscheincodes";
        case "ja":
          return "Google Workspace プロモーションコード";
        case "hi":
          return "Google Workspace प्रोमो कोड";
        case "ru":
          return "Промокоды Google Workspace";
        default:
          return "Google Workspace Promo Codes";
      }
    };
    const getLocalizedDescription = () => {
      switch (locale.value) {
        case "fr":
          return "Obtenez 10% de réduction exclusive sur les forfaits Google Workspace Business avec nos codes promo.";
        case "es":
          return "Obtenga un 10% de descuento exclusivo en los planes de Google Workspace Business con nuestros códigos promocionales.";
        case "pt":
          return "Obtenha 10% de desconto exclusivo nos planos Google Workspace Business com nossos códigos promocionais.";
        case "de":
          return "Erhalten Sie 10% Rabatt auf Google Workspace Business-Pläne mit unseren Gutscheincodes.";
        case "ja":
          return "プロモーションコードで Google Workspace Business プランが10%オフ。";
        case "hi":
          return "हमारे प्रोमो कोड के साथ Google Workspace बिजनेस प्लान पर 10% की विशेष छूट पाएं।";
        case "ru":
          return "Получите эксклюзивную скидку 10% на планы Google Workspace Business с нашими промокодами.";
        default:
          return "Get exclusive 10% discount on Google Workspace Business plans with our promo codes.";
      }
    };
    useHead({
      htmlAttrs: {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_1;
      const _component_LanguageSelector = _sfc_main$3;
      const _component_NuxtPage = __nuxt_component_2;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-white" }, _attrs))}><nav class="bg-white border-b border-gray-200"><div class="max-w-2xl mx-auto px-4"><div class="flex justify-between h-14"><div class="flex items-center">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img src="https://assets.gwsave.com/header-logo.svg" alt="GWsave" class="h-4"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath2)("/starter"),
        class: "inline-flex items-center px-2 py-1 text-sm text-gray-700 hover:text-blue-600"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"${_scopeId}></path></svg> ${ssrInterpolate(_ctx.$t("common.menu.starter"))}`);
          } else {
            return [
              ...
              createTextVNode(" " + toDisplayString$1(_ctx.$t("common.menu.starter")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath2)("/standard"),
        class: "inline-flex items-center px-2 py-1 text-sm text-gray-700 hover:text-blue-600"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"${_scopeId}></path></svg> ${ssrInterpolate(_ctx.$t("common.menu.standard"))}`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                class: "h-4 w-4 mr-1",
              ...
              createTextVNode(" " + toDisplayString$1(_ctx.$t("common.menu.standard")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(`</main><footer class="bg-white border-t border-gray-200"><div class="max-w-2xl mx-auto py-4 px-4"><div class="flex justify-center space-x-6 mb-4">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath2)("/about"),
        class: "inline-flex items-center text-sm text-gray-600 hover:text-blue-600"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"${_scopeId}></path></svg> ${ssrInterpolate(_ctx.$t("common.menu.about"))}`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                class: "h-4 w-4 mr-1",
              ...
              createTextVNode(" " + toDisplayString$1(_ctx.$t("common.menu.about")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath2)("/updates"),
        class: "inline-flex items-center text-sm text-gray-600 hover:text-blue-600"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"${_scopeId}></path></svg> ${ssrInterpolate(_ctx.$t("common.menu.updates"))}`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                class: "h-4 w-4 mr-1",
              ...
              createTextVNode(" " + toDisplayString$1(_ctx.$t("common.menu.updates")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath2)("/contact"),
        class: "inline-flex items-center text-sm text-gray-600 hover:text-blue-600"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"${_scopeId}></path></svg> ${ssrInterpolate(_ctx.$t("common.menu.contact"))}`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                class: "h-4 w-4 mr-1",
              ...
              createTextVNode(" " + toDisplayString$1(_ctx.$t("common.menu.contact")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</div><p class="text-center text-sm text-gray-600">${ssrInterpolate(_ctx.$t("common.copyright", { year: (/* @__PURE__ */ new Date()).getFullYear() }))}</p><div class="mt-4 text-center text-xs text-gray-500 space-y-2"><p>We are not affiliated with Google or Google Workspace. Google Workspace is a trademark of Google LLC.</p><p>We may earn a small affiliate commission when you purchase a Google Workspace plan using our promo codes.</p></div></div></footer></div>`);
    };
  }
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-white" }, _attrs))}><div class="max-w-2xl mx-auto px-4 py-16 sm:px-6 sm:py-24"><div class="text-center"><p class="text-sm font-semibold text-blue-600 uppercase tracking-wide">404 error</p><h1 class="mt-2 text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl"> Page not found </h1><p class="mt-4 text-lg text-gray-500"> Sorry, we couldn&#39;t find the page you&#39;re looking for. </p><div class="mt-8">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath2)("/"),
...
export { __nuxt_component_1 as _, useHead as a, useSupabaseUser as b, useRouter as c, useLocalePath as d, entry$1 as default, useNuxtApp as e, asyncDataDefaults as f, createError as g, fetchDefaults as h, useRequestFetch as i, defineNuxtRouteMiddleware as j, executeAsync as k, navigateTo as n, useI18n as u };
